...
<head>
  <title>Citas | Orejotas y Colitas</title>
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      <!-- Menu -->
      <?php $seccionSelected = 'citas';
      require('./cuerpo/menu.php') ?>
      <!-- / Menu -->
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Orejotas y Colitas /</span>
              Citas</h4>
            <div class="d-grid mb-3">
              <button class="btn btn-primary btn-toggle-sidebar btnAgregarNuevaCita">
            ...
            <div class="card app-calendar-wrapper">
              <div class="row g-0">
                ...
                <div class="col app-calendar-sidebar displayNone" id="app-calendar-sidebar">
                  ...
                  <div class="p-3">
                    ...
                    <!-- Filter -->
                    <div class="mb-3 ms-3 displayNone">
                      <small class="text-small text-muted text-uppercase align-middle">Casos</small>
                    </div>

                    <div class="form-check mb-2 ms-3 displayNone">
                      <input class="form-check-input select-all" type="checkbox" id="selectAll" data-value="all" checked />
                      <label class="form-check-label" for="selectAll">View All</label>
                    </div>

                    <div class="app-calendar-events-filter ms-3 displayNone">
            ...
            <!-- <div class="col-md mt-4 mb-md-0">
                  <div class="card">
                    <h5 class="card-header">Estados de las citas en colores</h5>
                    <div class="card-body">
                      <div class="alert alert-primary text-center" role="alert">Este color indica que la cita aún está pendiente. Business 2</div>

                      <div class="alert alert-success text-center" role="alert">Este color indica que la cita fue realizada. Holiday 1</div>

                      <div class="alert alert-danger text-center" role="alert">Este color indica que la cita fue cancelada. Personal 0</div>
            ...
            <div class="card mt-4">
              <div class="card-datatable table-responsive pt-0">
                <h5 class="card-header">Tabla de citas</h5>
                <table class="datatables-basic table" id="tabla-citas">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Mascota</th>
                      ...
                      <th>Hora de terminación esperada</th>
                      <!-- <th>Veterinario</th> -->
                      <th>Estado</th>
                      <th></th>
                      <!-- <th>Servicios</th> -->
  ...
  <!-- Edit User Modal -->
  <?php require('./modals/nuevaCitaModal.php'); ?>
  <?php require('./modals/modalCambiarEstadoCita.php'); ?>
  <?php require('./modals/editarCitaModal.php'); ?>
  <?php require('./modals/detalleCitaModal.php'); ?>
  ...
  <script src="../src/js/editarCita.js"></script>
  <!-- <script src="../src/js/pruebaCitas.js"></script> -->

  <!-- <script src="../src/js/app-calendar-events.js"></script> -->
  <script src="../src/js/app-calendar.js"></script>
